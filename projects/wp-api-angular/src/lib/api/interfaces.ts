...
import { HttpRequest,HttpHeaders, HttpContext,HttpParams  } from '@angular/common/http';
...
export interface IParent {
  httpGet(url: string, options?:  HttpRequest<any>): Observable<Object>;
...
export interface IWpApiPosts {
  ...
  getCategory(postId: number, categoryId:number, options?: RequestOptionsArgs): Observable<Object>;
  getTagList(postId: number, options?: RequestOptionsArgs): Observable<Object>;
  getTag(postId: number, tagId: number, options?: RequestOptionsArgs): Observable<Object>;
}
